import { Workflow, ChevronRight, Brain, Telescope } from 'lucide-react';
import { STRENGTH_ICONS, CAP_ICONS, Target } from '@/lib/constants';
import type { Analysis, AiCapability } from '@/lib/data';
...
interface AiAnalysisProps {
  ...
  t: {
    aiAnalysis: string;
    strengthTags: { ai: string; automation: string; fullstack: string; dx: string };
    aiCapabilities: string;
    aiCaps: Record<string, string>;
  };
}
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap gap-4 mb-12">
            {currentAnalysis.strengths.map((item, i: number) => {
              ...
              const tag = [t.strengthTags.ai, t.strengthTags.automation, t.strengthTags.fullstack, t.strengthTags.dx][i];
